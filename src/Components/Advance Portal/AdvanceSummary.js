...
const AdvanceSummary = () => {
  ...
  const exportsiteNamePDF = () => {
    ...
    doc.autoTable({
      ...
      body: tableRows,
      theme: "grid",
      startY: selectedAdvanceSite ? 20 : 10,
      headStyles: {
        fillColor: [255, 255, 255],
        textColor: 0,
        lineWidth: 0.2,
                ...
                <table className="w-full border-collapse ">
                  <thead>
                    <tr className="bg-[#f8f1e5] text-left">
                      ...
                      <th className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => handleSort('pendingAdvance')}>
                        Advance
                        {sortConfig.key === 'pendingAdvance' && (
                          <span className="ml-1">{sortConfig.direction === 'asc' ? '↑' : '↓'}</span>
                        )}
                      </th>
                      <th className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => handleSort('billAmount')} >
                        Bill Amount
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-[#f8f1e5] text-left">
                      ...
                      <th className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => handleSiteSort('pendingAdvance')} >
                        Advance
                        {siteSortConfig.key === 'pendingAdvance' && (
                          <span className="ml-1">{siteSortConfig.direction === 'asc' ? '↑' : '↓'}</span>
                        )}
                      </th>
                      <th className="p-2 cursor-pointer hover:bg-gray-200" onClick={() => handleSiteSort('billAmount')} >
                        Bill Amount
