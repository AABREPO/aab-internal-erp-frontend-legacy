    ...
    <div>
      <div className="bg-white lg:flex gap-3 p-4 ml-5 mr-5 rounded-md lg:h-[128px] text-left">
        <div>
          ...
          <select
            value={subscriptionFilters.year}
        ...
        <div>
          ...
          <select
            value={subscriptionFilters.service}
        ...
        <div>
          ...
          <select
            value={subscriptionFilters.doorNo}
        ...
        <div>
          ...
          <select
            value={subscriptionFilters.shop}
        ...
        <div>
          ...
          <select
            value={subscriptionFilters.project}
      ...
      <div className="mt-4 overflow-x-auto bg-white p-4 ml-5 mr-5 rounded-md">
        ...
        <div className=" flex flex-col md:flex-row md:items-center md:justify-between mt-5 mb-3">
          ...
          <div className="flex items-center gap-3 font-semibold">
            ...
            <button className="h-10 px-4 bg-[#BF9853] text-white rounded-md" onClick={() => setIsSubscriptionCreateOpen(true)}>Create</button>
          </div>
        </div>
        ...
        {isSubscriptionCreateOpen && (
          <div className="fixed inset-0 z-30 flex items-center justify-center">
            <div className="absolute inset-0 bg-black/40" onClick={() => setIsSubscriptionCreateOpen(false)} />
            <div className="relative z-40 bg-white rounded-lg shadow-xl p-6 w-[860px] max-w-[92vw]">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Subscription Details</h3>
                <button className="text-red-600 text-2xl" onClick={() => setIsSubscriptionCreateOpen(false)}>×</button>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
                <div>
                  <label className="block font-semibold mb-1">Type</label>
                  <select value={subscriptionForm.type} onChange={(e) => handleFormChange('type', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none appearance-none">
                ...
                <div>
                  ...
                  <input value={subscriptionForm.number} onChange={(e) => handleFormChange('number', e.target.value)} placeholder="Enter here" className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Plan Number</label>
                  <input value={subscriptionForm.planNumber} onChange={(e) => handleFormChange('planNumber', e.target.value)} placeholder="Enter here" className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Mail Id</label>
                  <input value={subscriptionForm.mailId} onChange={(e) => handleFormChange('mailId', e.target.value)} placeholder="Enter here" className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Project</label>
                  <select value={subscriptionForm.project} onChange={(e) => handleFormChange('project', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none appearance-none">
                    <option value="">Select</option>
                    <option>Clients</option>
                    <option>Own</option>
                  </select>
                ...
                <div>
                  ...
                  <select value={subscriptionForm.purpose} onChange={(e) => handleFormChange('purpose', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none appearance-none">
                    <option value="">Select</option>
                    <option>Office</option>
                ...
                <div>
                  <label className="block font-semibold mb-1">Amount</label>
                    <input value={subscriptionForm.amount} onChange={(e) => handleFormChange('amount', e.target.value)} placeholder="Enter here" className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Payment Date</label>
                  <input type="date" value={subscriptionForm.paymentDate} onChange={(e) => handleFormChange('paymentDate', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Service Start Date</label>
                  <input type="date" value={subscriptionForm.serviceStart} onChange={(e) => handleFormChange('serviceStart', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none" />
                </div>
                <div>
                  <label className="block font-semibold mb-1">Validity</label>
                  <div className="flex gap-2">
                    <input type="number" min="0" value={subscriptionForm.validityValue} onChange={(e) => handleFormChange('validityValue', Number(e.target.value))} className="h-11 w-20 border-2 border-[#BF9853] border-opacity-30 rounded-md px-3 focus:outline-none" />
                    <select value={subscriptionForm.validityUnit} onChange={(e) => handleFormChange('validityUnit', e.target.value)} className="h-11 flex-1 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none appearance-none">
                      <option value="">Select</option>
                ...
                <div>
                  ...
                  <select value={subscriptionForm.registeredPerson} onChange={(e) => handleFormChange('registeredPerson', e.target.value)} className="w-full h-11 border-2 border-[#BF9853] border-opacity-30 rounded-lg px-3 focus:outline-none appearance-none">
                    <option value="">Select</option>
                    <option>Amir H</option>
                    <option>Jothi S</option>
                  </select>
              ...
              <div className="px-2 pt-4 flex gap-4">
                <button
                  ...
                  onClick={() => { setIsSubscriptionCreateOpen(false); resetForm(); }}
                >
                  Submit
                </button>
                <button
                  className="px-6 py-2 border border-[#BF9853] text-[#BF9853] rounded-md"
                  onClick={() => { setIsSubscriptionCreateOpen(false); }}
                >
                  Cancel
                </button>
              </div>
