        ...
        <div className={wrapperClass}>
            ...
            >
                <span
                    ...
                    className={`text-[14px] flex-1 min-w-0 text-left truncate overflow-hidden text-ellipsis whitespace-nowrap ${hasDateFilter ? 'text-black font-bold' : 'text-[#A6A5A6] font-normal'}`}
                >
