...
const AMC_EXPENSES_ENDPOINT = 'https://backendaab.in/aabuilderDash/expenses_form/utility/amc';
...
const AMCDatabase = ({ username, userRoles = [] }) => {
    ...
    useEffect(() => {
        const fetchAmcData = async () => {
            try {
                const response = await axios.get(AMC_EXPENSES_ENDPOINT);
                setAmcData(response.data || []);
                setFilteredData(response.data || []);
            } catch (err) {
                console.error('Error fetching AMC data:', err);
                setError('Failed to fetch AMC data');
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleExportExcel = () => {
        ...
        const worksheetData = filteredData.map((item, index) => ({
            ...
            'AMC Number': item.utilityTypeNumber || '-',
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'AMCExpenses');
        XLSX.writeFile(workbook, 'AMCExpenses.xlsx');
    };
        ...
        <div className="bg-[#FAF6ED] rounded-lg shadow-sm">
                    ...
                    <div className="flex text-left gap-4">
                        <div>
                            ...
                            <Select
                                ...
                                onChange={(opt) => handleFilterChange('siteName', opt ? opt.value : '')}
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onChange={(opt) => handleFilterChange('vendor', opt ? opt.value : '')}
                        ...
                        <div>
                            <label className="block font-semibold mb-1">AMC Number</label>
                            <Select
                                ...
                                onChange={(opt) => handleFilterChange('utilityTypeNumber', opt ? opt.value : '')}
                                placeholder="Select AMC Number"
                                isClearable
                                isSearchable
                                styles={customSelectStyles}
                                className="w-full"
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onChange={(opt) => handleFilterChange('contractor', opt ? opt.value : '')}
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onChange={(opt) => handleFilterChange('paymentMode', opt ? opt.value : '')}
            ...
            <div className="bg-white rounded-md ml-5 mr-5 p-6">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-gray-800">AMC Expenses</h3>
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-[#FAF6ED]">
                                    ...
                                    <td className="px-4 py-2 text-left font-semibold">AMC Number</td>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="13" className="text-center py-4">No AMC expenses found</td>
                                    </tr>
                                ) : (
