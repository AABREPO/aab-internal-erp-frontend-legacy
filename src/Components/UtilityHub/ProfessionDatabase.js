...
const PROFESSION_EXPENSES_ENDPOINT = 'https://backendaab.in/aabuilderDash/expenses_form/utility/profession';
...
const ProfessionDatabase = ({ username, userRoles = [] }) => {
    ...
    useEffect(() => {
        const fetchProfessionData = async () => {
            try {
                const response = await axios.get(PROFESSION_EXPENSES_ENDPOINT);
                setProfessionData(response.data || []);
                setFilteredData(response.data || []);
            } catch (err) {
                console.error('Error fetching profession data:', err);
    ...
    const handleExportPDF = () => {
        ...
        doc.setFontSize(14);
        doc.text('Profession Tax Expenses', 14, 20);
        ...
        doc.save('ProfessionTaxExpenses.pdf');
    };
    ...
    const handleExportExcel = () => {
        ...
        const worksheetData = filteredData.map((item, index) => ({
            ...
            'Profession Tax No': item.utilityTypeNumber || '-',
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'ProfessionTaxExpenses');
        XLSX.writeFile(workbook, 'ProfessionTaxExpenses.xlsx');
    };
        ...
        <div className="bg-[#FAF6ED] rounded-lg shadow-sm">
            <div className="bg-white rounded-md mb-5 h-[128px] ml-5 mr-5">
                <div className="p-6">
                    <div className="flex text-left gap-4">
                        ...
                        <div>
                            <label className="block font-semibold mb-1">Profession Tax No</label>
                            <Select
                                ...
                                placeholder="Select Profession Tax No"
                                isClearable
                                isSearchable
                                styles={customSelectStyles}
                                className="w-full"
            ...
            <div className="bg-white rounded-md ml-5 mr-5 p-6">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-gray-800">Profession Tax Expenses</h3>
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-[#FAF6ED]">
                                    ...
                                    <td className="px-4 py-2 text-left font-semibold">Profession Tax No</td>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="13" className="text-center py-4">No profession tax expenses found</td>
                                    </tr>
                                ) : (
