...
const Header = ({ title = "Request For Quotation", showBack = true, showNotification = true, showProfile = true, user, onLogout, onMenuClick  }) => {
    ...
    <>
      <div className="fixed top-[0px] left-1/2 transform -translate-x-1/2 w-full max-w-[400px] h-[50px] bg-white z-40" style={{ fontFamily: "'Manrope', sans-serif" }}>
        <div className="relative flex items-center justify-between px-[16px]  h-full">
          ...
          {/* Title */}
          <p className="absolute left-[125px] transform -translate-x-1/2 font-semibold text-[14px] text-black leading-normal">
            {title}
          </p>
